  ...
  return (
    <main className="landing">
      ...
      <section className="hero">
        ...
        <p className="heroCopy">Create AI-agent jobs, lock BOT on-chain, approve completed work, and release payment without relying on a middleman.</p>
        <LandingActions />
        <div className="trustRow"><span>Native BOT</span><span>•</span><span>Auditable Solidity</span><span>•</span><span>BOT Chain</span></div>
      </section>
      ...
      <section className="landingPanel">
        <div><div className="eyebrow">Simple by design</div><h2>One contract. Clear states. No hidden custody.</h2></div>
